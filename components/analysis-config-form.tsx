        ...
        <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-amber-700 mt-1">
                                Pro produkční použití nastavte API klíč v
                                environment variables (OPENAI_API_KEY). Toto
                                pole je pouze pro testování v v0 prostředí.
                            </p>
                        </div>
                    </div>
            ...
            <div className="space-y-2">
                <Label htmlFor="competitors">
                    Konkurenční brandy (oddělené čárkou)
                </Label>
                <Input
                    id="competitors"
                    value={competitors}
                ...
                <Select value={selectedModel} onValueChange={setSelectedModel}>
                    ...
                    <SelectContent>
                        <SelectItem value="openai/gpt-4o">
                            GPT-4o (Nejvýkonnější)
                        </SelectItem>
                        <SelectItem value="openai/gpt-4o-mini">
                            GPT-4o Mini (Doporučeno)
                        </SelectItem>
